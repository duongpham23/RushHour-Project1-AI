...
class State:
    ...
    def is_goal(self, goal_position):
        ...
        if main_object.orientation == 0:
            ...
            if upper_most_row - 1 == goal_row or lower_most_row + 1 == goal_row:
                return True
            else:
                return False
        # horizontal case    
            ...
            if right_most_col + 1 == goal_col or left_most_col - 1 == goal_col:
                return True
            else:
                return False
...
def generate_child_state(current_state):
    ...
    for object_id, object in current_state.objects.items():
        ...
        if object.orientation == 0:
            ...
            # move up
            if current_state.map[upper_most_row - 1][col] == 0:
                ...
                # Add to frontier
                frontier.append(State(new_map, new_objects, current_state.gn + object.length, current_state))
                
            # move down
            if current_state.map[lower_most_row + 1][col] == 0:
                # create and modify new state's map
                new_map = copy.deepcopy(current_state.map)
        ...
        # horizontal case
            ...
            # move left
            if current_state.map[row][left_most_col - 1] == 0:
                # create and modify new state's map
                new_map = copy.deepcopy(current_state.map)
            ...
            # move right
            if current_state.map[row][right_most_col + 1] == 0:
                # create and modify new state's map
                new_map = copy.deepcopy(current_state.map)
